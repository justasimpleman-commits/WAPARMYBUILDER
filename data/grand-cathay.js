...
(window.ARMY_BOOKS = window.ARMY_BOOKS || {})["grand-cathay"] = {
  ...
  listRules: [
    ...
    "Each Guardian Lion must be either a Jade Lion or a Jet Lion (must choose one).",
    "Blademaster may never be the Army General.",
    "Expendable Core units require at least one non-Expendable Core unit.",
    "Seal of Xing Po* is restricted to Dragon-Blooded Shugengan or Dragon Descendant only.",
    "Fan of the Magister is restricted to Lord Magistrate or Magistrate only.",
    "Scrolls of Astromancy are restricted to Astromancer only."
  ],
  ...
  magicItems: {
    ...
    "Magic Armour": [
      ...
      { name: "Shield of Nan-Gau", cost: 10, requiresAccess: "shield" }
    ],
    "Talismans": [
      { name: "Guardian Feng Shi Bo", cost: 40 },
      { name: "Robes of Shang Yang", cost: 40 },
      { name: "Crystal of Kunlan", cost: 30 },
      { name: "Jet Amulet", cost: 25 },
      { name: "Sigil of Smoke & Powder", cost: 25 },
      { name: "Jade Blood Pendant", cost: 20 },
      { name: "Jar of All Souls", cost: 20 },
      { name: "Celestial Silk Robe", cost: 15, common: true },
      { name: "Crown of Jade", cost: 10, common: true }
    ],
    "Arcane Items": [
    ...
    "Enchanted Items": [
      ...
      { name: "Icon of the Spirit Dragon", cost: 35 },
      { name: "Kite of the Uttermost Airs", cost: 35 },
      { name: "Cleansing Water", cost: 30 },
      { name: "Crackleblaze", cost: 30 },
      ...
      { name: "Alchemist's Elixir of Iron Skin", cost: 10, common: true },
      { name: "Alchemist's Elixir of Puissance", cost: 10, common: true },
      { name: "Cloak of the Moon Wind", cost: 10 },
      { name: "Alchemist's Elixir of Venom", cost: 5, common: true }
    ],
    "Magic Standards": [
      { name: "Flag of Grand Cathay", cost: 55 },
      { name: "The Great Celestial Banner", cost: 50 },
      { name: "Jade Banner", cost: 30 },
      { name: "Standard of Wei Jin", cost: 30 },
      { name: "Banner of Feng Shi", cost: 25 },
      { name: "Banner of the Empress' Eye", cost: 25 },
      { name: "Banner of the Moon Empress", cost: 25 },
      { name: "Revered Banner of the Ancestors", cost: 25 },
      { name: "Serene Cloud Prayer Flag", cost: 25 },
      { name: "Standard of Heavenly Fury", cost: 25 },
      { name: "Banner of the Dragon's Wrath", cost: 20 },
      { name: "Standard of Shang-Yang", cost: 20 },
      { name: "Dragon's Eye Banner", cost: 15 },
      { name: "Bastion Standard", cost: 15 },
      { name: "Standard of Nan-Gau", cost: 10 },
      { name: "Banner of Xen Wun", cost: 10 }
    ]
  },
  ...
  itemDesc: {
    "Jade Blade of the Great Fleet": `The wielder of this weapon gains +1 Strength and the Regeneration (5+) special rule.`,
    "Nuku Cho's Crossbow": `Repeater crossbow. Range 18/24", Strength 3, Multiple Shots (6), Rapid Fire.`,
    ...
    "Blade of Xen Wu": `The wielder gains +1 Strength and +1 Attack. However, any unit joined by them cannot use their Leadership.`,
    "Serpent Fang": `The wielder gains the Armour Piercing (2) and Poisoned Attacks special rules.`,
    "Sword of Nan-Gau": `The wielder gains Armour Piercing (3) and Hatred (Chaos).`,
    "Vermillion Blade": `The wielder gains +1 To Hit and Flaming Attacks.`,
    "Sun & Moon Blades": `Two hand weapons with Armour Piercing (1) and Immunity (Killing Blow).`,
    "Wrath of Xen Yang": `Light lance/spear with the Flaming Attacks special rule.`,
    "Jade Armour of Beichai": `Heavy armour. The wearer gains Magical Ward (5+) and Magic Resistance (2).`,
    "Quicksilver Armour": `Medium armour. The wearer gains the Always Strikes First special rule.`,
    "Scales of the Celestial Court": `Medium armour. The wearer gains Natural Armour (5+) and Strider.`,
    "Armour of the Warbird": `Infantry only. Medium armour. The wearer gains Fly (10) and Independent.`,
    "Ascendant Celestial Armour": `Heavy armour. The wearer is immune to penalties to any characteristics and automatically passes all characteristics tests.`,
    "Laminate Shield": `Shield. Every time the bearer makes a successful Parry save, they may immediately make an additional Attack back against the model that struck the blow.`,
    "Mantle of Heaven": `The wearer gains a 5+ armour save against non-magical missile attacks.`,
    "Shield of Nan-Gau": `Shield. The bearer gains +2 armour save against all attacks to their front in the first round of close combat.`,
    "Guardian Feng Shi Bo": `All close combat and missile attacks targeting the bearer must re-roll successful To Hit rolls.`,
    "Robes of Shang Yang": `Bound Spell (Wall of Wind & Fire, Lore of Yang). The bearer also gains Magical Ward (6+) against missile attacks.`,
    "Crystal of Kunlan": `The bearer gains Magical Ward (5+). For each successful Ward save in close combat, the enemy that struck the blow immediately suffers a Strength 3 Flaming hit.`,
    "Jet Amulet": `The bearer and any unit they join gain Magic Resistance (2). The bearer may re-roll any failed dispel attempts against spells directly targeting them or their unit.`,
    "Sigil of Smoke & Powder": `All missile attacks targeting the bearer or any unit they are with suffer -1 To Hit.`,
    "Jade Blood Pendant": `Whenever the bearer kills one or more enemy models in close combat, roll a D6 at the end of the Close Combat phase. On a 5+, the bearer recovers a single Wound lost earlier.`,
    "Jar of All Souls": `One use only. If the bearer is killed, immediately roll a D6. On a 2+, they come back to life with 1 Wound remaining.`,
    "Celestial Silk Robe": `The wearer gains Magical Ward (6+) and Magic Resistance (1). Common.`,
    "Crown of Jade": `The bearer gains a 4+ invulnerable save against all enemy spells. Common.`,
    ...
    "Cleansing Water": `The bearer and any unit they join gain Mighty Blow (1) in turns that they charge.`,
    "Crackleblaze": `One use, in the Shooting phase. Place the small 3" template anywhere within 6". It scatters D3". Models under the template suffer Strength 4 hits with Flaming Attacks and Ignores Armour Saves.`,
    "Spirit Lantern": `The bearer gains Terror and may re-roll To Wound rolls of 1 against Daemons, Undead and Vampires.`,
    "Catalytic Kiln": `All enemy models in base contact with the bearer suffer a Strength 3 Flaming hit at the start of each close combat phase. Models with Immunity (Flaming Attacks) suffer a Strength 2 hit instead.`,
    "Astromancer's Spyglass": `+1 to choosing table side, first turn and Ambusher arrival rolls. All enemy units within 30" must reveal all Hidden models and magic items.`,
    "Fan of the Magister": `Lord Magistrate or Magistrate only. Friendly units may re-roll failed Leadership tests for Tactician. Enemy units within 12" must re-roll successful tests to march, counter-charge, redirect charges, restrain pursuit and reform.`,
    "Fires of Nan-Gau": `One use only. The bearer gains a Breath Weapon (Strength 4, Flaming Attacks). Common.`,
    "Golden Lion": `The bearer and any unit they are with may re-roll failed Psychology tests. Common.`,
    "Vermillion Quills": `One use only. At the start of close combat, the bearer may re-roll all failed To Hit and To Wound rolls this turn. Common.`,
    "Alchemist's Elixir of Iron Skin": `One use only. At the start of any phase, the character gains Natural Armour (3+) until end of turn. Common.`,
    "Alchemist's Elixir of Puissance": `One use only. At the start of any phase, the character gains +1 Strength and Attacks until end of turn. Common.`,
    "Cloak of the Moon Wind": `Model on foot only. The bearer gains the Scouts special rule.`,
    "Alchemist's Elixir of Venom": `One use only. At the start of any phase, the character gains Poisoned Attacks until end of turn. Common.`,
    "Flag of Grand Cathay": `The bearer gains Hold Your Ground (6). Friendly units within 18" count as being in Harmony if within 6" of eligible Yin/Yang units rather than 3".`,
    "The Great Celestial Banner": `The unit gains Magical Ward (5+).`,
    "Jade Banner": `The unit gains +2 combat resolution bonus.`,
    "Standard of Wei Jin": `The unit gains +1 Leadership; enemy units in base contact suffer -1 Leadership.`,
    "Banner of Feng Shi": `The unit gains Immunity (Psychology) and Magical Attacks.`,
    "Banner of the Empress' Eye": `The unit gains +1 To Hit with missile weapons.`,
    "Banner of the Moon Empress": `Infantry only. The unit gains the Scouts special rule.`,
    "Revered Banner of the Ancestors": `The unit gains +1 Weapon Skill.`,
    "Serene Cloud Prayer Flag": `The unit gains the Cold-blooded special rule.`,
    "Standard of Heavenly Fury": `One use only. At the start of any enemy Movement phase, until start of your next turn, no enemy unit within 24" can use the Fly special rule.`,
    "Banner of the Dragon's Wrath": `The unit gains Flaming Attacks and Impact Hits (1).`,
    "Standard of Shang-Yang": `The unit may re-roll 1's when taking armour saves.`,
  ...
  units: {
    ...
    characters: [
      {
        ...
        options: [
          ...
          { id: "ranged", type: "choice", label: "Ranged weapon", choices: [
            { label: "Shortbow", cost: 4 },
            { label: "Repeater crossbow", cost: 5 },
      ...
      {
        id: "alchemists", name: "Alchemists", isCharacter: true,
        access: ["light armour"],
        lores: ["Metal"],
        variants: [
          { name: "Grand Alchemist", points: 160, wizardLevel: 3, magicBudget: 100 },
          { name: "Alchemist", points: 65, wizardLevel: 1, magicBudget: 50 }
        ],
        options: [
          { id: "wlvl", type: "toggle", label: "Additional Wizard Level", cost: 35, per: "flat" },
          { id: "armour", type: "toggle", label: "Light armour", cost: 3, per: "flat" },
      ...
      {
        id: "astromancers", name: "Astromancers", isCharacter: true,
        access: ["light armour"],
        lores: ["Heavens"],
        variants: [
          { name: "Supreme Astromancer", points: 160, wizardLevel: 3, magicBudget: 100 },
          { name: "Astromancer", points: 65, wizardLevel: 1, magicBudget: 50 }
        ],
        options: [
          { id: "wlvl", type: "toggle", label: "Additional Wizard Level", cost: 35, per: "flat" },
          { id: "armour", type: "toggle", label: "Light armour", cost: 3, per: "flat" },
      ...
      },
      {
        ...
        options: [
          ...
          { id: "ranged", type: "choice", label: "Ranged weapon", choices: [
            { label: "Shortbow", cost: 4 },
            { label: "Longbow", cost: 6 },
            { label: "Repeater crossbow", cost: 6 },
            { label: "Crossbow", cost: 7 }
          ]},
          { id: "armour", type: "choice", label: "Armour", choices: [
            { label: "Light armour", cost: 3 },
      ...
      {
        id: "magistrates", name: "Magistrates", isCharacter: true,
        access: ["light armour"],
        variants: [
          { name: "Lord Magistrate", points: 85, magicBudget: 100 },
          { name: "Magistrate", points: 50, magicBudget: 50 }
        ],
        options: [
      ...
      {
        id: "liuyun", name: "Liu Yun", isCharacter: true, isSpecialChar: true,
        access: [],
      ...
      {
        id: "huagongzhu", name: "Hua Gongzhu", isCharacter: true, isSpecialChar: true,
      ...
      {
        id: "tianshi", name: "Tian Shi", isCharacter: true, isSpecialChar: true,
        access: ["light armour"],
        variants: [ { name: "Tian Shi", points: 335, wizardLevel: 4, magicBudget: 0 } ],
        lores: ["Heavens"],
        options: [
          { id: "armour", type: "toggle", label: "Light armour", cost: 3, per: "flat" },
          { id: "mount", type: "mount", label: "Mount", choices: [
      ...
      {
        id: "zhugeyi", name: "Zhuge Yi", isCharacter: true, isSpecialChar: true,
        access: [],
      ...
      {
        id: "chenglong", name: "Cheng Long", isCharacter: true, isSpecialChar: true, cannotBeGeneral: true,
        access: [],
        variants: [ { name: "Cheng Long", points: 190, magicBudget: 0 } ],
        options: [],
        notes: "Must always accept challenges. May not be the Army General."
      },
      {
        id: "saytang", name: "Saytang the Watcher", isCharacter: true, isSpecialChar: true,
        access: ["heavy armour"],
        variants: [ { name: "Saytang the Watcher", points: 295, magicBudget: 0 } ],
        options: [],
        notes: "Fixed item: Wind Bow."
      },
      {
        id: "monkeyking", name: "The Monkey King", isCharacter: true, isSpecialChar: true, cannotBeGeneral: true,
        access: ["light armour"],
        variants: [ { name: "The Monkey King", points: 155, magicBudget: 0 } ],
        options: [],
        notes: "May only join units of Monkey Warriors. May never be the Army General."
      }
    ],
    ...
    core: [
      ...
      {
        id: "peasantbowmen", name: "Peasant Bowmen", perModel: true, basePoints: 4, unitSize: [10, 30],
        expendable: true,
        options: [
          { id: "bow", type: "choice", label: "Replace shortbows", choices: [
            { label: "Repeater crossbows", cost: 1, per: "model" },
            { label: "Longbows", cost: 2, per: "model" },
      ...
      {
        id: "peasanthorsemen", name: "Peasant Horsemen", perModel: true, basePoints: 9, unitSize: [5, 15],
        expendable: true,
        options: [
          { id: "wep", type: "choice", label: "Weapon/ranged", choices: [
      ...
      {
        id: "jadebowmen", name: "Jade Bowmen", perModel: true, basePoints: 6, unitSize: [10, 30],
        options: [
          { id: "bow", type: "choice", label: "Replace shortbows", choices: [
            { label: "Repeater crossbows", cost: 1, per: "model" },
            { label: "Longbows", cost: 2, per: "model" },
      ...
      {
        id: "jadehorsemen", name: "Jade Horsemen", perModel: true, basePoints: 11, unitSize: [5, 15],
        options: [
          { id: "wep", type: "choice", label: "Weapon/ranged", choices: [
            { label: "Shortbows", cost: 1, per: "model" },
            { label: "Crossbows", cost: 2, per: "model" },
            { label: "Light lances & shields", cost: 2, per: "model" },
            { label: "Flails", cost: 2, per: "model" },
            { label: "Polearms", cost: 2, per: "model" },
            { label: "Three-eyed guns", cost: 5, per: "model" }
          ]},
          { id: "armour", type: "toggle", label: "Medium armour", cost: 1, per: "model" },
      ...
      {
        id: "ironhailgunners", name: "Iron Hail Gunners", perModel: true, basePoints: 9, unitSize: [10, 30],
        options: [
          { id: "wep", type: "choice", label: "Replace blunderbusses", choices: [
            { label: "Handguns", cost: 0, per: "model" },
            { label: "Three-eyed guns", cost: 3, per: "model" }
          ]},
          { id: "armour", type: "toggle", label: "Medium armour", cost: 1, per: "model" },
          { id: "cmd", type: "command", magicStandard: 25 }
        ]
      ...
      {
        id: "hilltribesmen", name: "Hill Tribesmen", perModel: true, basePoints: 2.5, unitSize: [10, 30],
        expendable: true,
        options: [
          { id: "wep", type: "choice", label: "Weapon", choices: [
            { label: "Additional hand weapons", cost: 1, per: "model" },
            { label: "Spears", cost: 1, per: "model" },
            { label: "Javelins", cost: 2, per: "model" },
            { label: "Shortbows", cost: 2, per: "model" }
          ]},
          { id: "shield", type: "toggle", label: "Shields (not with two HW/shortbows)", cost: 1, per: "model" },
      ...
      {
        id: "monkeywarriors", name: "Monkey Warriors", perModel: true, basePoints: 5, unitSize: [10, 30],
        expendable: true,
        options: [
          { id: "wep", type: "choice", label: "Weapon", choices: [
            { label: "Additional hand weapons", cost: 1, per: "model" },
            { label: "Blowpipes", cost: 3, per: "model" }
          ]},
    ...
    special: [
      {
        id: "celestialdragonguard", name: "Celestial Dragon Guard", perModel: true, basePoints: 10, unitSize: [10, 30],
        options: [
          { id: "wep", type: "choice", label: "Replace polearms", choices: [
            { label: "Great weapons", cost: 1, per: "model" },
            { label: "Dragon crossbows", cost: 4, per: "model" }
          ]},
          { id: "shield", type: "toggle", label: "Shields (if armed with polearms)", cost: 1, per: "model" },
          { id: "armour", type: "toggle", label: "Heavy armour", cost: 1.5, per: "model" },
          { id: "cmd", type: "command", magicStandard: 50 }
        ]
      },
      {
        id: "celestialdragonlancers", name: "Celestial Dragon Lancers", perModel: true, basePoints: 18, unitSize: [5, 15],
        options: [
          { id: "wep", type: "choice", label: "Replace light lances & shields", choices: [
            { label: "Polearms", cost: 0, per: "model" },
            { label: "Flails", cost: 0, per: "model" }
          ]},
          { id: "firelance", type: "toggle", label: "Fire lances (if armed with light lances)", cost: 2, per: "model" },
          { id: "armour", type: "toggle", label: "Heavy armour", cost: 2, per: "model" },
          { id: "cmd", type: "command", magicStandard: 50 }
        ]
      },
      {
        id: "celestialdragonmonks", name: "Celestial Dragon Monks", perModel: true, basePoints: 15, unitSize: [5, 15],
        options: [
          { id: "wep", type: "choice", label: "Weapon", choices: [
            { label: "Additional hand weapons", cost: 1.5, per: "model" },
            { label: "Polearms", cost: 2, per: "model" }
          ]},
          { id: "leader", type: "toggle", label: "Leader", cost: 5, per: "flat" }
        ]
      ...
      {
        id: "cranegunners", name: "Crane Gunners", perModel: true, basePoints: 15, unitSize: [5, 15],
        options: [
          { id: "armour", type: "toggle", label: "Medium armour", cost: 2, per: "model" }
        ],
        notes: "Unit Strength 2 per model."
      },
      {
      ...
      {
        id: "flamethrower", name: "Flamethrower", perModel: true, basePoints: 20, unitSize: [1, 2],
        notes: "1–2 Flamethrowers count as a single Special choice.", countsAsSingleChoice: true,
        options: []
      },
      {
      ...
      {
        id: "templedogs", name: "Temple Dogs", perModel: true, basePoints: 25, unitSize: [5, 15],
        options: []
      },
      {
      ...
      {
        id: "onyxcrowmen", name: "Onyx Crowmen", perModel: true, basePoints: 16, unitSize: [5, 15],
        expendable: true,
        options: [
          { id: "leader", type: "toggle", label: "Leader", cost: 5, per: "flat" }
        ]
      ...
      {
        id: "firerainrocket", name: "Fire Rain Rocket", perModel: false, basePoints: 85, unitSize: [1, 1],
        options: [
    ...
    rare: [
      {
        id: "longmariders", name: "Longma Riders", perModel: true, basePoints: 48, unitSize: [3, 6],
        options: [
          { id: "wep", type: "toggle", label: "Replace light lances & shields with polearms", cost: 0, per: "model" },
          { id: "armour", type: "toggle", label: "Heavy armour", cost: 4, per: "model" },
          { id: "barding", type: "toggle", label: "Barding", cost: 2, per: "model" },
          { id: "cmd", type: "command", magicStandard: 50 }
        ]
      },
      {
        id: "grandcannon", name: "Grand Cannon", perModel: false, basePoints: 125, unitSize: [1, 1],
        options: [
          { id: "ogre", type: "toggle", label: "Ogre Loader", cost: 20, per: "flat" },
          { id: "armour", type: "choice", label: "Crew armour", choices: [
            { label: "Light armour (3 Crew)", cost: 3, per: "flat" },
      ...
      {
        id: "zhanguwardrum", name: "Zhangu War Drum", perModel: false, basePoints: 120, unitSize: [1, 1],
        options: [
          { id: "armour", type: "toggle", label: "Medium armour", cost: 10, per: "flat" }
        ]
      },
      {
        id: "wuxingwarcompass", name: "Wu Xing War Compass", perModel: false, basePoints: 125, unitSize: [1, 1],
        options: []
      },
      {
      ...
      {
        id: "celestiallion", name: "Celestial Lion", perModel: false, basePoints: 145, unitSize: [1, 1],
        options: []
      },
      {
        id: "greatmoonbird", name: "Great Moon Bird", perModel: false, basePoints: 140, unitSize: [1, 1],
        options: []
      },
      {
        id: "terracottasentinel", name: "Terracotta Sentinel", perModel: false, basePoints: 235, unitSize: [1, 1],
        options: [
          { id: "upgrade", type: "choice", label: "Sentinel upgrade", choices: [
            { label: "Jade Sentinel", cost: 10 },
            { label: "Obsidian Sentinel", cost: 20 },
            { label: "Warpstone Sentinel", cost: 20 },
            { label: "Granite Sentinel", cost: 25 }
          ]}
        ]
      },
      {
