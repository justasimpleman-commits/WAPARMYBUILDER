/*
 * mobile-init.js — mobile-only enhancements for the Capacitor build.
 *
 * This file exists ONLY in mobile/www/. sync-web.js injects a <script> tag for
 * it into the www copy of index.html, so the shared desktop index.html is never
 * modified (single source of truth — see CLAUDE.md).
 *
 * Adds, for the phone form factor:
 ...
 * app's render() keeps populating them exactly as before.
 */
(function () {
  ...
  function init() { buildShell(); wireBack(); }
